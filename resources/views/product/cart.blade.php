        ...
        @php $total += $details['price'] * $details['quantity'] @endphp
          ...
          <li class="flex py-6 sm:py-10" data-id="{{ $id }}">
            <div class="flex-shrink-0">
              <img src="{{asset('/image/'.$details['image'])}}" alt="Front of men&#039;s Basic Tee in sienna." class="h-24 w-24 rounded-md object-cover object-center sm:h-48 sm:w-48">
            </div>
